    ...
    <header className="bg-gradient-to-r from-blue-600 via-blue-500 to-green-500 text-white relative overflow-hidden">
      ...
      <div className="container mx-auto px-3 sm:px-4 py-8 sm:py-12 md:py-16 relative z-10">
        <div className="flex flex-col items-center text-center space-y-4 sm:space-y-6">
          {/* Ícone principal */}
          <div className="bg-white/20 backdrop-blur-sm p-4 sm:p-5 rounded-2xl shadow-2xl animate-scale-in">
            <Calculator className="w-10 h-10 sm:w-12 sm:h-12 md:w-14 md:h-14" />
          </div>
          ...
          {/* Badge de economia */}
          <div className="flex items-center gap-2 bg-white/10 backdrop-blur-sm px-4 sm:px-6 py-2 sm:py-3 rounded-full animate-fade-in" style={{ animationDelay: "0.2s" }}>
